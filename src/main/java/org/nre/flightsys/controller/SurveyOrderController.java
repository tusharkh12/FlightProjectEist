...
public class SurveyOrderController {
    ...
    @PostMapping("/order")
    private ResponseEntity<String> takeOrder(@RequestParam("user") String user, @RequestParam("foodItem") String foodItem, @RequestParam("drinkItem") String drinkItem) {
        try {
    ...
    private ResponseEntity<String> submitSurvey(@RequestParam("user") String user, @RequestParam("rating1") int rating1, @RequestParam("rating2") int rating2, @RequestParam("rating3") int rating3, @RequestParam("comment") String comment) {
        try {
